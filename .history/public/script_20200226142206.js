...
function showModalWinner(){
  document.querySelector('.js-modal-shopify win').classList.toggle('is-shown--off-flow');
  document.querySelector('.js-modal-shopify win').classList.toggle('is-hidden--off-flow');
}
